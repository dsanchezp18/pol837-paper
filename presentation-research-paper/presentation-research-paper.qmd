...
- I compute weighted averages for every canton in Ecuador, assigning weights based on the boundaries of cantons and the area of each grid cell that falls within each canton.
:::

## Data: The AmericasBarometer {.smaller}
...
- Dichotomized the variable to a binary indicator of approval (1 or 2 responses) and (indifferent or disapproval).
...
![Presidential Approval Ratings](/figures/approval_rating_by_year.jpg)
